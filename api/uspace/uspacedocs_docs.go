// Package uspace Code generated by swaggo/swag. DO NOT EDIT
package uspace

import "github.com/swaggo/swag"

const docTemplateuspacedocs = `{
    ...
    "paths": {
        "/admin/app": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Pagination limit for listing applications",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Pagination offset for listing applications",
                        "name": "offset",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Comma-separated application IDs to fetch or delete",
                        "name": "ids",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Application name (used with version)",
                        "name": "name",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Application version (used with name)",
                        "name": "version",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Single application ID to delete",
                        "name": "id",
                        "in": "query"
                    },
                    {
                        "description": "Single application object (POST/PUT)",
                        "name": "app",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kyri56xcaesar_kuspace_internal_utils.Application"
                        }
                    },
                    {
                        "description": "Multiple application objects (POST)",
                        "name": "apps",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Success with application(s) content or status",
                        "schema": {
                            "type": "object",
                    ...
                    "400": {
                        "description": "Bad request (e.g., malformed input)",
                        "schema": {
                            "type": "object",
        ...
        "/app": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Comma-separated application IDs to filter",
                        "name": "ids",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Application name to fetch specific app",
                        "name": "name",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Application version to fetch specific app",
                        "name": "version",
                        "in": "query"
                    },
                    {
                        "description": "Single application object (for POST)",
                        "name": "app",
                        "in": "body",
                        "required": true,
                        "schema": {
                    ...
                    {
                        "description": "Multiple applications (for POST)",
                        "name": "apps",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/resource/ownership": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Resource owner updated successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/resource/permissions": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "New permission string (e.g., rwxr-x---)",
                        "name": "permissions",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/resource/preview": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Byte range to preview (e.g., 'bytes=0-4095')",
                        "name": "Range",
                        "in": "header"
                    }
                ],
                "responses": {
                    ...
                    "416": {
                        "description": "Requested range exceeds file size",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
    ...
    "definitions": {
        "kyri56xcaesar_kuspace_internal_utils.Application": {
            "type": "object",
            "properties": {
                "author": {
                    "type": "string"
        ...
        "kyri56xcaesar_kuspace_internal_utils.UserVolume": {
            "type": "object",
            "properties": {
                "quota": {
                    "type": "number"
...
// SwaggerInfouspacedocs holds exported Swagger Info so clients can modify it
var SwaggerInfouspacedocs = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:8079",
	BasePath:         "/api/v1",
	Schemes:          []string{"http"},
	...
	InfoInstanceName: "uspacedocs",
	SwaggerTemplate:  docTemplateuspacedocs,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfouspacedocs.InstanceName(), SwaggerInfouspacedocs)
}

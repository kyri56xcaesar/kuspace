// Package minioth Code generated by swaggo/swag. DO NOT EDIT
package minioth

import "github.com/swaggo/swag"

const docTemplateminiothdocs = `{
...
// SwaggerInfominiothdocs holds exported Swagger Info so clients can modify it
var SwaggerInfominiothdocs = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:8080",
	BasePath:         "/v1",
	Schemes:          []string{"http"},
	...
	InfoInstanceName: "miniothdocs",
	SwaggerTemplate:  docTemplateminiothdocs,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfominiothdocs.InstanceName(), SwaggerInfominiothdocs)
}
